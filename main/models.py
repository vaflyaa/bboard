...
class Bb(models.Model):
    ...
    # удаляем все связанные доп иллюстрации, вызовом диспетчера обратной связи
...
class Rubric(models.Model):
    ...
    # поле заполняется, если запись хранит подрубрику. Отсутствие значения - признак надрубрики

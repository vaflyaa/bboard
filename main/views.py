...
from .forms import ChangeUserInfoForm, RegisterUserForm, SearchForm, BbForm,  UserCommentForm, GuestCommentForm, AIFormSet
...
def profile_bb_add(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            bb = form.save()
            # Сначала выполняется валидация и сохр. формы, потом передаем ее набору форм, тобы связать иллюстрации с bb
